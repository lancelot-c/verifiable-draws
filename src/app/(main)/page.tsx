...
const tiers = [
    {
        ...
        features: [
            ...
            { included: false, text: 'Not pinned on IPFS' },
    ...
    },
    {
        ...
        features: [
            ...
            { included: true, text: 'Access on our private gateway verify.win' },
            { included: true, text: 'Pinned on IPFS' },
            { included: true, text: 'Support on our Discord' },
        ],
        mostPopular: true,
        cta: 'Launch draw',
                    ...
                    <div className="mx-auto max-w-7xl px-6 lg:px-8">
                        <div className="mx-auto max-w-3xl text-center">
                            ...
                            <div className="mt-10 flex items-center justify-center gap-x-6">
                                ...
                                <Link href="https://www.verify.win/bafybeicn37a6jl6px6myeoadkxowbpr4d7e3yf2gb5hxman6xd3gxdu6yy" className="text-sm font-semibold leading-6 text-gray-900">
            ...
            <div id="join-community" className="relative -z-10 mx-auto py-32 max-w-7xl px-6 sm:py-40 lg:px-8">
                ...
                <div className="mx-auto max-w-2xl text-center">
                    ...
                    <p className="mx-auto mt-6 max-w-xl text-lg leading-8 text-gray-600">
                        It contains everything you need to know: API endpoints, frequently asked questions, code samples, in-depth explanations, ...
